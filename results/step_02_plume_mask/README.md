...
- Planet SR GeoTIFF: `smoke-plume-data/palisades/planet/20250110_185256_28_24e1_3B_AnalyticMS_SR_8b.tif`
- Bands used (1-based indexing, as in `scripts/smoke_plume_pipeline.py`):
  - **Blue**: band **2**
  - **NIR**: band **8**
